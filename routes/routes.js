...
router.get('/hotels', authenticateUser, lang, async (req, res)=>{
    try {
        const currentLanguage = req.session.language || 'en';
        res.render('hotels', {  isAdmin: req.user.role, hotels: null, translation: res.locals.translation, currentLanguage }); 
    } catch (error) {
        console.error(error);
...
router.post('/hotels', authenticateUser, lang, async (req, res)=>{
    try {
        ...
        res.render('hotels', { isAdmin: req.user.role, search, hotels:response.data, translation: res.locals.translation, currentLanguage });
    } catch (error) {
